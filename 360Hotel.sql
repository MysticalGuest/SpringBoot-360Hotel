...
insert  into `administrator`(`AdmId`,`aName`,`aPassword`,`aSex`,`limit`) values ('001','肖精兵','36088888','男','administrator'),('3601','前台1','2919966','女','front'),('3602','前台2','2919966','女','front'),('3603','备用','2919966','女','front');
